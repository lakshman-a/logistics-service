...
public class ShipmentController {
	...
	//	return shipmentRepository.findById(shipmentId).orElseThrow(() -> new ResourceNotFoundException("Shipment", "id", shipmentId));
		return shipmentService.getShipmentById(shipmentId);
	}

	// Update a Shipment
	@PutMapping("/shipment/{id}")
	public Shipment updateShipment(@PathVariable(value = "id") String shipmentId, @Valid @RequestBody Shipment ShipmentDetails) {
